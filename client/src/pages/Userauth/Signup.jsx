...
import { TextField, Button, MenuItem, Typography, Box, Dialog, DialogActions, DialogContent, DialogTitle, Slide, Grid, useMediaQuery, InputAdornment } from '@mui/material';
...
export default function StudentRegistrationForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/v1/users/register-user`, {
        method: 'POST',
        headers: {
