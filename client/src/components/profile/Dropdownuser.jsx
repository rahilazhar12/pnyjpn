...
const DropdownUser = () => {
  ...
  return (
    <div className="relative">
        ...
        <span className="hidden text-right lg:block">
          {user ? (
            <>
              ...
              <span className="block text-xs">{user.role || "User"}</span>
            </>
          ) : (
            <span className="block text-sm font-medium text-black dark:text-white">
              Guest
      ...
      {/* Dropdown Start */}
      {dropdownOpen && (
        <div className="absolute right-0 mt-4 w-64 flex flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <ul
