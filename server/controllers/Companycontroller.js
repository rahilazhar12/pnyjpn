...
const CreateCompany = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json({ message: "Verification code sent. Please check your email to complete registration." });
...
const VerifyCompany = async (req, res) => {
    ...
    if (company.verificationCode === code) {
        ...
        await company.save();
        return res.status(200).json({ message: "Verification successful. Your account is now pending admin approval." });
    } else {
